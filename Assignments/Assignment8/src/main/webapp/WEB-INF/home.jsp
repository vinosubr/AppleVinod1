...
<caption><h2>List of Aliens</h2></caption>
		<tr>
            ...
            <c:forEach var="alienMapEntry" items="${aliens.alienMap}">
                <tr>
                    <td><c:out value="${alienMapEntry.value.aid}" /></td>
                    <td><c:out value="${alienMapEntry.value.aname}" /></td>
                    <td><c:out value="${alienMapEntry.value.age}" /></td>                    
                </tr>
            </c:forEach>
        </table>
